...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.sourceControlPublishRepositoryWithPrompts]: AuthOrchestrationOperateScope,
  [WS_METHODS.sourceControlResolveSshPasswordPrompt]: AuthOrchestrationOperateScope,
